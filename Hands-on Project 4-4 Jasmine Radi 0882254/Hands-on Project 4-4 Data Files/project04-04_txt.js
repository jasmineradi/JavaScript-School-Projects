...
function calcChange(changeValue) {
   ...
   changeValue -=  bill20Amt*20;
                                          console.log("After $20 bills, changeValue:", changeValue); // Trace here
   ...
   changeValue -=  bill10Amt*10;
                                          console.log("After $10 bills, changeValue:", changeValue); // Trace here
   ...
   changeValue -=  bill5Amt*5;  
                                          console.log("After $5 bills, changeValue:", changeValue); // Trace here
   ...
   changeValue -=  bill1Amt*1;  
                                          console.log("After $1 bills, changeValue:", changeValue); // Trace here
   ...
   changeValue -= coin25Amt*0.25;   
                                          console.log("After quarters, changeValue:", changeValue); // Trace here
   ...
   changeValue -= coin10Amt*0.10; 
                                          console.log("After dimes, changeValue:", changeValue); // Trace here
   ...
   changeValue -= coin5Amt*0.05;  
                                          console.log("After nickels, changeValue:", changeValue); // Trace here
   ...
   document.getElementById("coin1").innerHTML = coin1Amt;
                                          console.log("Pennies:", coin1Amt); // Trace here
                                          console.log("Final change value: ", changeValue); // Trace here
}
